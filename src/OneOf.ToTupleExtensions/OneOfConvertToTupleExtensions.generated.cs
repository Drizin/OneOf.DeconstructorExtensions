...
namespace OneOf
{
    #nullable enable
    /// <summary>
    /// Extensions that converts OneOf into a Tuple that can be desconstructed.
    ...
    /// </summary>
    public static class OneOfToTupleExtensions
    {
        /// <summary>
        ...
        /// All optional parameters named "dummy" will be ignored - they are just used for compiler disambiguation (to find the right combination of reference-types and value-types)
        /// </summary>
        public static Tuple<Nullable<T0>, Nullable<T1>> ToTuple<T0, T1>(this OneOf<T0, T1> oneOf, RequireStruct<T0>? dummy0 = null, RequireStruct<T1>? dummy1 = null)
            where T0 : struct
            where T1 : struct
        {
        ...
        /// All optional parameters named "dummy" will be ignored - they are just used for compiler disambiguation (to find the right combination of reference-types and value-types)
        /// </summary>
        public static Tuple<Nullable<T0>, Nullable<T1>, Nullable<T2>> ToTuple<T0, T1, T2>(this OneOf<T0, T1, T2> oneOf, RequireStruct<T0>? dummy0 = null, RequireStruct<T1>? dummy1 = null, RequireStruct<T2>? dummy2 = null)
            where T0 : struct
            where T1 : struct
            where T2 : struct
        {
        ...
        /// All optional parameters named "dummy" will be ignored - they are just used for compiler disambiguation (to find the right combination of reference-types and value-types)
        /// </summary>
        public static Tuple<Nullable<T0>, Nullable<T1>, Nullable<T2>, Nullable<T3>> ToTuple<T0, T1, T2, T3>(this OneOf<T0, T1, T2, T3> oneOf, RequireStruct<T0>? dummy0 = null, RequireStruct<T1>? dummy1 = null, RequireStruct<T2>? dummy2 = null, RequireStruct<T3>? dummy3 = null)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        /// All optional parameters named "dummy" will be ignored - they are just used for compiler disambiguation (to find the right combination of reference-types and value-types)
        /// </summary>
        public static Tuple<Nullable<T0>, Nullable<T1>, Nullable<T2>, Nullable<T3>, Nullable<T4>> ToTuple<T0, T1, T2, T3, T4>(this OneOf<T0, T1, T2, T3, T4> oneOf, RequireStruct<T0>? dummy0 = null, RequireStruct<T1>? dummy1 = null, RequireStruct<T2>? dummy2 = null, RequireStruct<T3>? dummy3 = null, RequireStruct<T4>? dummy4 = null)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        /// All optional parameters named "dummy" will be ignored - they are just used for compiler disambiguation (to find the right combination of reference-types and value-types)
        /// </summary>
        public static Tuple<Nullable<T0>, Nullable<T1>, Nullable<T2>, Nullable<T3>, Nullable<T4>, Nullable<T5>> ToTuple<T0, T1, T2, T3, T4, T5>(this OneOf<T0, T1, T2, T3, T4, T5> oneOf, RequireStruct<T0>? dummy0 = null, RequireStruct<T1>? dummy1 = null, RequireStruct<T2>? dummy2 = null, RequireStruct<T3>? dummy3 = null, RequireStruct<T4>? dummy4 = null, RequireStruct<T5>? dummy5 = null)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
        ...
        /// All optional parameters named "dummy" will be ignored - they are just used for compiler disambiguation (to find the right combination of reference-types and value-types)
        /// </summary>
        public static Tuple<Nullable<T0>, Nullable<T1>, Nullable<T2>, Nullable<T3>, Nullable<T4>, Nullable<T5>, Nullable<T6>> ToTuple<T0, T1, T2, T3, T4, T5, T6>(this OneOf<T0, T1, T2, T3, T4, T5, T6> oneOf, RequireStruct<T0>? dummy0 = null, RequireStruct<T1>? dummy1 = null, RequireStruct<T2>? dummy2 = null, RequireStruct<T3>? dummy3 = null, RequireStruct<T4>? dummy4 = null, RequireStruct<T5>? dummy5 = null, RequireStruct<T6>? dummy6 = null)
            where T0 : struct
            where T1 : struct
            where T2 : struct
            where T3 : struct
